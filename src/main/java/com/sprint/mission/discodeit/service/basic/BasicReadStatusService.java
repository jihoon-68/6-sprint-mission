...
import com.sprint.mission.discodeit.exception.ReadStatusAlreadyExistException;
...
public class BasicReadStatusService implements ReadStatusService {
    ...
    public ReadStatusDto create(ReadStatusCreateRequest request) {
        ...
        Channel channel = channelRepository.findById(channelId)
            .orElseThrow(
                () -> {
                    Map<String, Object> details = Map.of("channelId", channelId);
        ...
        if (readStatusRepository.existsByUserIdAndChannelId(user.getId(), channel.getId())) {
            ...
            throw new ReadStatusAlreadyExistException(details);
        }
    ...
    public ReadStatusDto find(UUID readStatusId) {
        return readStatusRepository.findById(readStatusId)
            ...
            .orElseThrow(
                () -> {
                    Map<String, Object> details = Map.of("readStatusId", readStatusId);
