...
public class UserController {
    ...
    public ResponseEntity<UserDto> update(
        ...
        UserDto updatedUser = userService.update(userId, userUpdateRequest, Optional.ofNullable(profile));
    ...
    @Operation(summary = "UserId로 User 상태 조회", operationId = "getUserStatusByUserId")
    @GetMapping(path = "{userId}/userStatus")
    public ResponseEntity<UserStatusDto> getUserStatusByUserId(@PathVariable("userId") UUID userId) {
